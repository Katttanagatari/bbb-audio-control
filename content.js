...
(function() {
  ...
  **/
  function init() {
    ...
    // createVolumeInterface(targetEl, remoteMediaEl); // create interface
  }
  ...
  **/
  ...
  //   const [container, containerForInput, slider, newButton] = createUI(targetEl);
...
////////////////////////////////////////////////////
  ...
  //       console.log(remoteMedia.volume)
  ...
  function createEvents(ui,remoteMedia){
    changeVolume(ui,remoteMedia);

  }

  function changeVolume(ui,remoteMedia){
    ui.slider.addEventListener('input', () => {
      if (remoteMedia) {
        remoteMedia.volume = ui.slider.value;  // set volume on handler
        console.log(remoteMedia.volume)
